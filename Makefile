...
build:
	$(GO) build ./cmd/broker ./cmd/gh-agent-broker ./cmd/broker-issue-reporter ./cmd/sandbox-broker ./cmd/gh-agent-proxy ./cmd/repository-backend
...
sandbox-e2e-fast:
	SANDBOX_E2E_MODE=fast ./scripts/sandbox-e2e.sh
