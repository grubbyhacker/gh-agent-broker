...
result_json() {
  ...
  if [[ "$outcome" == 'ready_for_review' ]]; then
    printf ',"pull_request":%s,"delivered_head_sha":"1111111111111111111111111111111111111111","validated_tree_sha":"2222222222222222222222222222222222222222"' "$pull_request"
  fi
  printf '}'
}
